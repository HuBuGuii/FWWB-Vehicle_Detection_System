...
@Service
public class NonRealTimeDetectionRecordServiceImpl extends ServiceImpl<NonRealTimeDetectionRecordMapper, NonRealTimeDetectionRecord>
        implements NonRealTimeDetectionRecordService {
}